...
.method public static getActualDefaultRingtoneUri(Landroid/content/Context;I)Landroid/net/Uri;
    ...
    const-string/jumbo v7, "ringtone_original"
    ...
    .line 666
    .local v2, strRingtone:Ljava/lang/String;
    invoke-virtual {p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v6

    const-string/jumbo v7, "notification_original"
    ...
    invoke-static {p0, v6, p1}, Landroid/media/RingtoneManager;->getRealRingtoneUri(Landroid/content/Context;Landroid/net/Uri;I)Landroid/net/Uri;

    move-result-object v4

    .line 676
    .local v4, temp:Landroid/net/Uri;
    goto :goto_0
.end method
...
.method private static getRingtone(Landroid/content/Context;Landroid/net/Uri;I)Landroid/media/Ringtone;
    ...
    .line 627
    invoke-static {p0, p1, p2}, Landroid/media/RingtoneManager;->getRealRingtoneUri(Landroid/content/Context;Landroid/net/Uri;I)Landroid/net/Uri;
    ...
    invoke-direct {v1, p0, v5}, Landroid/media/Ringtone;-><init>(Landroid/content/Context;Z)V
    ...
    const-string v6, "getRingtone ringtoneStr == nul--+"
    ...
    invoke-virtual {v1, v5}, Landroid/media/Ringtone;->setUri(Landroid/net/Uri;)V
    ...
    :cond_1
    invoke-virtual {v1, v3}, Landroid/media/Ringtone;->setUri(Landroid/net/Uri;)V
    :try_end_0
