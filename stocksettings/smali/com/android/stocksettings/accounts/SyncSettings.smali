.class public Lcom/android/stocksettings/accounts/SyncSettings;
...
.method private removeAccountPreferences()V
    ...
    .prologue
    .line 127
    invoke-virtual {p0}, Lcom/android/stocksettings/accounts/SyncSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    instance-of v2, v2, Lcom/android/stocksettings/AccountPreference;
...
.method private startAccountSettings(Lcom/android/stocksettings/AccountPreference;)V
    ...
    .line 113
    invoke-virtual {p0, v0}, Lcom/android/stocksettings/accounts/SyncSettings;->startActivity(Landroid/content/Intent;)V

    .line 114
    invoke-virtual {p0}, Lcom/android/stocksettings/accounts/SyncSettings;->finish()V
...
.method public onAccountsUpdated([Landroid/accounts/Account;)V
    ...
    .prologue
    .line 139
    invoke-virtual {p0}, Lcom/android/stocksettings/accounts/SyncSettings;->getActivity()Landroid/app/Activity;
    ...
    .line 141
    :cond_0
    invoke-direct {p0}, Lcom/android/stocksettings/accounts/SyncSettings;->removeAccountPreferences()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/stocksettings/accounts/SyncSettings;->getAuthoritiesForAccountType(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mAuthorities:[Ljava/lang/String;
    ...
    .line 149
    iget-object v6, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mAuthorities:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/stocksettings/accounts/SyncSettings;->getDrawableForType(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1}, Lcom/android/stocksettings/accounts/SyncSettings;->getLabelForType(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/stocksettings/AccountPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/android/stocksettings/accounts/SyncSettings;->onSyncStateUpdated()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mAutoSyncPreference:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v1, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mAuthorities:[Ljava/lang/String;

    .line 89
    invoke-virtual {p0}, Lcom/android/stocksettings/accounts/SyncSettings;->updateAuthDescriptions()V
...
.method protected onAuthDescriptionsUpdated()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/stocksettings/accounts/SyncSettings;->getDrawableForType(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    invoke-virtual {v0, v3}, Lcom/android/stocksettings/AccountPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/stocksettings/accounts/SyncSettings;->getLabelForType(Ljava/lang/String;)Ljava/lang/CharSequence;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/stocksettings/accounts/SyncSettings;->addPreferencesFromResource(I)V
    ...
    iput-object v0, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mAutoSyncPreference:Landroid/preference/CheckBoxPreference;

    .line 59
    iget-object v0, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mAutoSyncPreference:Landroid/preference/CheckBoxPreference;

    new-instance v1, Lcom/android/stocksettings/accounts/SyncSettings$1;

    invoke-direct {v1, p0}, Lcom/android/stocksettings/accounts/SyncSettings$1;-><init>(Lcom/android/stocksettings/accounts/SyncSettings;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/stocksettings/accounts/SyncSettings;->setHasOptionsMenu(Z)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .end local p2
    invoke-direct {p0, p2}, Lcom/android/stocksettings/accounts/SyncSettings;->startAccountSettings(Lcom/android/stocksettings/AccountPreference;)V
...
.method public showDialog(I)V
    ...
    .prologue
    .line 119
    iget-object v0, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mDialogFragment:Lcom/android/stocksettings/SettingsPreferenceFragment$SettingsDialogFragment;
    ...
    iput-object v0, p0, Lcom/android/stocksettings/accounts/SyncSettings;->mDialogFragment:Lcom/android/stocksettings/SettingsPreferenceFragment$SettingsDialogFragment;
