.class public Lcom/android/stocksettings/DeviceAdminSettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/stocksettings/DeviceAdminSettings$PolicyListAdapter;,
        Lcom/android/stocksettings/DeviceAdminSettings$ViewHolder;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mActiveAdmins:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mAvailableAdmins:Ljava/util/ArrayList;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 69
    invoke-virtual {p0}, Lcom/android/stocksettings/DeviceAdminSettings;->getActivity()Landroid/app/Activity;
    ...
    iput-object v0, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
...
.method public onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    const-class v3, Lcom/android/stocksettings/DeviceAdminAdd;
    ...
    .line 145
    invoke-virtual {p0, v1}, Lcom/android/stocksettings/DeviceAdminSettings;->startActivity(Landroid/content/Intent;)V
...
.method public onResume()V
    ...
    .line 76
    iget-object v0, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;

    invoke-virtual {v0}, Landroid/app/admin/DevicePolicyManager;->getDeviceOwner()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;

    .line 77
    iget-object v0, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;

    iget-object v1, p0, Lcom/android/stocksettings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;
    ...
    .line 80
    :cond_0
    invoke-virtual {p0}, Lcom/android/stocksettings/DeviceAdminSettings;->updateList()V
...
.method updateList()V
    ...
    iget-object v0, v0, Lcom/android/stocksettings/DeviceAdminSettings;->mActiveAdmins:Ljava/util/HashSet;
    ...
    iget-object v0, v0, Lcom/android/stocksettings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    .line 93
    invoke-virtual/range {p0 .. p0}, Lcom/android/stocksettings/DeviceAdminSettings;->getActivity()Landroid/app/Activity;
    ...
    .end local v13           #ri:Landroid/content/pm/ResolveInfo;
    :cond_8
    invoke-virtual/range {p0 .. p0}, Lcom/android/stocksettings/DeviceAdminSettings;->getListView()Landroid/widget/ListView;

    move-result-object v16

    new-instance v17, Lcom/android/stocksettings/DeviceAdminSettings$PolicyListAdapter;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/stocksettings/DeviceAdminSettings$PolicyListAdapter;-><init>(Lcom/android/stocksettings/DeviceAdminSettings;)V
