.class public Lcom/android/stocksettings/net/UidDetailProvider;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/stocksettings/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/stocksettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method private buildUidDetail(I)Lcom/android/stocksettings/net/UidDetail;
    .locals 18
    .parameter "uid"
    ...
    iget-object v14, v0, Lcom/android/stocksettings/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    new-instance v3, Lcom/android/stocksettings/net/UidDetail;

    invoke-direct {v3}, Lcom/android/stocksettings/net/UidDetail;-><init>()V

    .line 94
    .local v3, detail:Lcom/android/stocksettings/net/UidDetail;
    move/from16 v0, p1
    ...
    iput-object v14, v3, Lcom/android/stocksettings/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v14, v3, Lcom/android/stocksettings/net/UidDetail;->icon:Landroid/graphics/drawable/Drawable;
    ...
    .line 124
    invoke-static {v12, v5, v11}, Lcom/android/stocksettings/users/UserUtils;->getUserIcon(Landroid/os/UserManager;Landroid/content/pm/UserInfo;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Lcom/android/stocksettings/Utils;->getTetheringLabel(Landroid/net/ConnectivityManager;)I
    ...
    :cond_3
    :goto_3
    iget-object v14, v3, Lcom/android/stocksettings/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v14, v3, Lcom/android/stocksettings/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    iget-object v14, v3, Lcom/android/stocksettings/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
...
.method public clearCache()V
    ...
    .prologue
    .line 55
    iget-object v1, p0, Lcom/android/stocksettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;

    monitor-enter v1

    .line 56
    :try_start_0
    iget-object v0, p0, Lcom/android/stocksettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method public getUidDetail(IZ)Lcom/android/stocksettings/net/UidDetail;
    .locals 3
    .parameter "uid"
    .parameter "blocking"
    ...
    .prologue
    .line 66
    iget-object v2, p0, Lcom/android/stocksettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
    ...
    check-cast v0, Lcom/android/stocksettings/net/UidDetail;

    .line 68
    .local v0, detail:Lcom/android/stocksettings/net/UidDetail;
    monitor-exit v2
    ...
    .line 68
    .end local v0           #detail:Lcom/android/stocksettings/net/UidDetail;
    :catchall_0
    move-exception v1
    ...
    .line 72
    .restart local v0       #detail:Lcom/android/stocksettings/net/UidDetail;
    :cond_0
    if-nez p2, :cond_1
    ...
    .line 76
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/stocksettings/net/UidDetailProvider;->buildUidDetail(I)Lcom/android/stocksettings/net/UidDetail;
