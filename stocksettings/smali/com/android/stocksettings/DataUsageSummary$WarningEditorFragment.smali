.class public Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;
...
.method public static show(Lcom/android/stocksettings/DataUsageSummary;)V
    ...
    .line 1940
    new-instance v1, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;

    invoke-direct {v1}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;-><init>()V

    .line 1941
    .local v1, dialog:Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;
    invoke-virtual {v1, v0}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 1942
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 1948
    invoke-virtual {p0}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    .line 1949
    .local v7, context:Landroid/content/Context;
    invoke-virtual {p0}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {v3, v4}, Lcom/android/stocksettings/net/NetworkPolicyEditor;->getPolicyWarningBytes(Landroid/net/NetworkTemplate;)J

    move-result-wide v12

    .line 1960
    .local v12, warningBytes:J
    invoke-virtual {v3, v4}, Lcom/android/stocksettings/net/NetworkPolicyEditor;->getPolicyLimitBytes(Landroid/net/NetworkTemplate;)J
    ...
    new-instance v0, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment$1;-><init>(Lcom/android/stocksettings/DataUsageSummary$WarningEditorFragment;Landroid/widget/NumberPicker;Lcom/android/stocksettings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/stocksettings/DataUsageSummary;)V
