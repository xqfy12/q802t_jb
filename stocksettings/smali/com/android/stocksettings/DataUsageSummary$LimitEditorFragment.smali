.class public Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;
...
.method public static show(Lcom/android/stocksettings/DataUsageSummary;)V
    ...
    .line 2003
    new-instance v1, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;

    invoke-direct {v1}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;-><init>()V

    .line 2004
    .local v1, dialog:Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;
    invoke-virtual {v1, v0}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 2005
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 2011
    invoke-virtual {p0}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    .line 2012
    .local v7, context:Landroid/content/Context;
    invoke-virtual {p0}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    new-instance v0, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment$1;-><init>(Lcom/android/stocksettings/DataUsageSummary$LimitEditorFragment;Landroid/widget/NumberPicker;Lcom/android/stocksettings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/stocksettings/DataUsageSummary;)V
