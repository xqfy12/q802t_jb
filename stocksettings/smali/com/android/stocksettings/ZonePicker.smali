.class public Lcom/android/stocksettings/ZonePicker;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/stocksettings/ZonePicker$MyComparator;,
        Lcom/android/stocksettings/ZonePicker$ZoneSelectionListener;
    }
.end annotation
...
.field private mListener:Lcom/android/stocksettings/ZonePicker$ZoneSelectionListener;
...
.method public static constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;
    ...
    invoke-static {p0, p1, v0}, Lcom/android/stocksettings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;ZI)Landroid/widget/SimpleAdapter;
...
.method public static constructTimezoneAdapter(Landroid/content/Context;ZI)Landroid/widget/SimpleAdapter;
    ...
    :goto_0
    new-instance v6, Lcom/android/stocksettings/ZonePicker$MyComparator;

    invoke-direct {v6, v7}, Lcom/android/stocksettings/ZonePicker$MyComparator;-><init>(Ljava/lang/String;)V

    .line 101
    .local v6, comparator:Lcom/android/stocksettings/ZonePicker$MyComparator;
    invoke-static {p0}, Lcom/android/stocksettings/ZonePicker;->getZones(Landroid/content/Context;)Ljava/util/List;
    ...
    .end local v6           #comparator:Lcom/android/stocksettings/ZonePicker$MyComparator;
...
.method private static getZones(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v5, v3, v2, v0, v1}, Lcom/android/stocksettings/ZonePicker;->addItem(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;J)V
...
.method private setSorting(Z)V
    ...
    iget-object v0, p0, Lcom/android/stocksettings/ZonePicker;->mTimezoneSortedAdapter:Landroid/widget/SimpleAdapter;

    .line 212
    .local v0, adapter:Landroid/widget/SimpleAdapter;
    :goto_0
    invoke-virtual {p0, v0}, Lcom/android/stocksettings/ZonePicker;->setListAdapter(Landroid/widget/ListAdapter;)V

    .line 213
    iput-boolean p1, p0, Lcom/android/stocksettings/ZonePicker;->mSortedByTimezone:Z
    ...
    invoke-static {v0, v2}, Lcom/android/stocksettings/ZonePicker;->getTimeZoneIndex(Landroid/widget/SimpleAdapter;Ljava/util/TimeZone;)I
    ...
    .line 216
    invoke-virtual {p0, v1}, Lcom/android/stocksettings/ZonePicker;->setSelection(I)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/stocksettings/ZonePicker;->mAlphabeticalAdapter:Landroid/widget/SimpleAdapter;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 150
    invoke-virtual {p0}, Lcom/android/stocksettings/ZonePicker;->getActivity()Landroid/app/Activity;
    ...
    invoke-static {v0, v1}, Lcom/android/stocksettings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;

    move-result-object v1

    iput-object v1, p0, Lcom/android/stocksettings/ZonePicker;->mTimezoneSortedAdapter:Landroid/widget/SimpleAdapter;

    .line 152
    invoke-static {v0, v2}, Lcom/android/stocksettings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;

    move-result-object v1

    iput-object v1, p0, Lcom/android/stocksettings/ZonePicker;->mAlphabeticalAdapter:Landroid/widget/SimpleAdapter;

    .line 155
    invoke-direct {p0, v2}, Lcom/android/stocksettings/ZonePicker;->setSorting(Z)V

    .line 156
    invoke-virtual {p0, v2}, Lcom/android/stocksettings/ZonePicker;->setHasOptionsMenu(Z)V
...
.method public onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    iget-object v5, p0, Lcom/android/stocksettings/ZonePicker;->mListener:Lcom/android/stocksettings/ZonePicker$ZoneSelectionListener;
    ...
    invoke-interface {v5, v3}, Lcom/android/stocksettings/ZonePicker$ZoneSelectionListener;->onZoneSelected(Ljava/util/TimeZone;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 193
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/android/stocksettings/ZonePicker;->setSorting(Z)V

    goto :goto_0

    .line 197
    :pswitch_1
    invoke-direct {p0, v1}, Lcom/android/stocksettings/ZonePicker;->setSorting(Z)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    .line 179
    iget-boolean v0, p0, Lcom/android/stocksettings/ZonePicker;->mSortedByTimezone:Z
